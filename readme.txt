...
This plugin adds suport for the tourtiger theme to the [Styles plugin](http://wordpress.org/extend/plugins/styles).

[Try a demo in tourtiger](http://demo.stylesplugin.com/tourtiger).
...
* tourtiger: [Demo](http://demo.stylesplugin.com/tourtiger)
...
1. Upload the `styles-tourtiger` folder to the `/wp-content/plugins/` directory
...
We believe life is better when we work together. :) Support for WordPress default themes, like tourtiger and TwentyThirteen, will always be free. Continued development in Styles will be supported by:
